                        ...
                        if (reply['button'] == true) {
                          return Padding(
                            ...
                            if (reply['message'] != 'Cancel Test' && reply['message'] != 'DASS-21 Scoring Guide' && reply['message'] != 'Back to Menu' && reply['message'] != 'Retest' && reply['message'] != 'Get Help' && reply['message'] != 'About Mental Illness') {
                              ...
                              var score = int.parse(number! as String);
                              print(score);
                              ...
                              String DASS_21Link = "http://www.farmerhealth.org.au/sites/default/files/DASS_21_Scoring_white_HEALTH_PROFESSIONAL_USE_ONLY_V_15.pdf";
                              if (await canLaunchUrl(DASS_21Link as Uri)) {
                                await launch(DASS_21Link);
                              } else {
                                throw 'Could not launch $DASS_21Link';
                              }
